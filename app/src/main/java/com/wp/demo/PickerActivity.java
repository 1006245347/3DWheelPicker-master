...
//                .setLeftTitleColor(0xFF1233DD)
                .setLeftTitleColor(0xFF333333)
//                .setLeftTitleColor(context.getColor(R.color.font_black))
                .setRightTitleColor(0xFF333333)
                .setMiddleTitleColor(0xFF333333)
                .setTitleBackground(0XFFDDDDDD)
                .setLeftTitleText(context.getString(R.string.cancel))
                .setRightTitleText(context.getString(R.string.finish));
    }
}
